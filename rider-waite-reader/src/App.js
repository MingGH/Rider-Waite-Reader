                ...
                <div className="test">
                    <form onSubmit={this.handleSubmit}>
                        ...
                        <div className="clear padded">
                            <h4>选择一个塔罗牌布局</h4>
                            <label>
                                <input type="radio" name="layout" value="onecard" defaultChecked
                        ...
                        <div className="clear padded">
                            ...
                            <label><input type="radio" name="focus" value="relationships"
                                          onChange={this.handleChange}/><span>人际关系</span></label>
                            <label><input type="radio" name="focus" value="work"
                                          onChange={this.handleChange}/><span>工作</span></label>
                            <label><input type="radio" name="focus" value="spiritual"
                                          onChange={this.handleChange}/><span>精神世界</span></label>
                            <label><input type="radio" name="focus" value="personalgrowth"
                                          onChange={this.handleChange}/><span>个人成长</span></label>
                            <label><input type="radio" name="focus" value="fortunetelling"
                                          onChange={this.handleChange}/><span>占卜未来</span></label>
                        </div>
                        <div className="clear padded">
                            <h4>是否允许出现倒置(逆位)的塔罗牌</h4>
                            ...
                            <div className="flex-col">
                                {cards[0].reversed
                                    ? <div className="item reversed"
                                           style={{backgroundImage: `url(${cards[0].imgpath})`}}/>
            ...
            <div>
                <div className="primary">
                    <div className="reading">
                        ...
                        <p className="center">This magician's spread shows the influences of the four directions on the
                            situation.</p>
                    </div>
                </div>
                    ...
                    <div className="reading">
                        ...
                        <div className="flex-row cards treeoflife-row">
                            ...
                            <div className="flex-col">
                                ...
                                <div
                                    className={"item taller treeoflife-card-six " + (cards[5].reversed ? 'reversed' : '')}
                                    style={{backgroundImage: `url(${this.props.cards[5].imgpath})`}}>
                                </div>
                                <div className={"item taller " + (cards[8].reversed ? 'reversed' : '')}
                                     style={{backgroundImage: `url(${this.props.cards[8].imgpath})`}}>
